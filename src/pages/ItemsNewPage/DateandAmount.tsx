...
export const DateandAmount:React.FC <Props>= (props) =>{
 ...
 return (
    <div>
    <div flex p-16px border-t-1px border-t="#ddd" gap-x-8px items-center color="#999">
    <Icon name='date' className="w-24px h-24px grow-0 shrink-0"/>
    <span grow-0 shrink-0 >2001-02-03</span> 
    <span grow-1 shrink-1 text-right color='#53A867'>金额</span> 
    </div>
    <div py-1px  className = {className} grid 
    grid-cols="[repeat(4,1fr)]" grid-rows="[repeat(4,48px)]" children-b-none children-bg-white
    bg="#ddd" gap-2px> 
